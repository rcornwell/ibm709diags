       ...
       REM           
       REM           9S04L
       REM           SECOND HALF OF TEST
       REM           WILL TEST THE LOW END OF
       REM           MEMORY FROM 00000 TO 75777
       REM           
       ORG 31744     
       REM           
       TRA NPER      
       REM           
 B     SLF           TURN OFF ALL SENSE LIGHTS
       SLN 1         TURN SENSE LIGHT 1 ON TO
       REM           INDICATE THAT THE LOW END
 ...
 B1    CLA ZERO      
       ...
       STO HIGH      
       REM           
       CLA LOW       LOWEST POSITION TESTED
 ...
 B3    CLA ADR       L BEAT ADDRESS
       ...
       TRA B5        BEAT EACH ADDRESS 500 TIMES
       SWT 5         TEST SENSE SWITCH 5
       TRA B4        BEAT EACH ADDRESS 1000 TIMES
       LXA K1750,1   
       TRA B6        BEAT EACH ADDRESS 5000 TIMES
 B4    LXA K310,1    
       TRA B6        
 B5    LXA K144,1    
       REM           
 ...
 B6    CLA ADR       L BEAT ADDRESS
       ...
       TRA B6A       BY PASS ERROR
       REM           
       SWT 3         TEST SENSE SWITCH 3
       TRA P         PRINT ERROR
       HTR B6A       ERROR - THE BEAT ADDRESS
 ...
 B6A   STQ           BEAT THE ADDRESS
       ...
       REM           
 B7    CLA 0,2       Y ADDRESS BEING CHECKED
       CAS FILL      
       TRA B7A       MAYBE AN ERROR
       TRA B7+5      OK
       TRA B7A       MAYBE AN ERROR
       TXH B8,2,768  
       TXI B7,2,128  
 ...
 B7A   CLA B7        
       ...
       TRA B7B       MAY BE AN ERROR
       TRA B7+5      OK-BEAT ADDRESS
 B7B   CAS K7        L LOWEST LOCATION OF PROG
       TRA B7+5      OK-PROGRAM AREA
       TRA B7+5      OK-PROGRAM AREA
       SWT 2         TEST SENSE SWITCH 2
       TRA *+2       INDICATE ERROR
       TRA B7C       BY PASS ERROR
       REM           
       SWT 3         TEST SENSE SWITCH 3
       TRA P1        PRINT ERROR
       HTR B7C       Y ERROR ADR IN ACC
       REM           BEAT ADDRESS LOCATED AT ADR
       REM           
 B7C   STA B7C+2     
       CLA FILL      
       STO           REPAIR Y ERROR
       TRA B7        CHECK REPAIR ADDRESS
       REM           
       REM           
       REM           
       REM           CHECK X ADDRESSES
       REM           
 B8    CLA 0,4       X ADDRESS BEING CHECKED
       CAS FILL      
       TRA B9        MAYBE AN ERROR
       TRA B8+5      OK
       TRA B9        MAYBE AN ERROR
       TXH B10,4,48  
       TXI B8,4,8    
 ...
 B9    CLA B8        
       ...
       SSP           
       CAS ADR       L BEAT ADDRESS
       TRA B9A       MAY BE AN ERROR
       TRA B8+5      OK BEAT ADDRESS
 B9A   CAS K7        L LOWEST LOCATION OF PROG
       TRA B8+5      OK-PROGRAM AREA
       TRA B8+5      OK-PROGRAM AREA
       SWT 2         TEST SENSE SWITCH 2
       TRA *+2       INDICATE ERROR
       TRA B9B       BY PASS ERROR
       REM
       SWT 3         TEST SENSE SWITCH 3
       TRA P2        PRINT ERROR
       HTR B9B       X ERROR ADR IN ACC
       REM           BEAT ADDRESS LOCATED AT ADR
       REM           
 B9B   STA B9B+2     
       CLA FILL      
       STO           REPAIR X ERROR
       TRA B8        CHECK REPAIR ADDRESS
       REM           
       REM           
       REM           
       REM           
 B10   CLA ADR       L BEAT ADDRESS
       STA B10+4     
       STA B11       
       ...
       TRA B10A      ERROR
       TRA B11-1     OK
 B10A  SWT 2         TEST SENSE SWITCH 2
       TRA *+2       INDICATE ERROR
       TRA B11-1     BY PASS ERROR
       REM           
       SWT 3         TEST SENSE SWITCH 3
       TRA P3        PRINT ERROR
       HTR B11-1     ERROR IN BEAT WORD
       ...
       REM           
       CLA FILL      
 B11   STO           RESET LAST BEAT ADDRESS
       CLA ADR       L BEAT ADDRESS
       ADD ONE       INCREASE BEAT ADDRESS
       CAS HIGH      
       HTR B11+5     SHOULD NEVER ENTER HERE
       TRA B12       REPEAT TEST WITH
       REM           NEXT PATTERN
       REM           
       STA ADR       NEW BEAT ADDRESS
       TRA B3        
       REM           
 B12   CLA LOW       
 ...
 PCOM  SWT 3         
       ...
       IOCD PPER,0,24 
       REM           
 B14   SWT 1         TEST SENSE SWITCH 1
       TRA B14+3     
       TRA B1+4      LOOP IN TEST
       REM           
 ...
 P1    STO P6        ERROR ADDRESS
       CLA K9A+1     L HTR B7B+4
       STO P7        ERROR EXIT
       CLA K9A+4     L TRA B7C
       STO P13       PROGRAM RETURN
       TRA P4        
 P2    STO P6        ERROR ADDRESS
       CLA K9A+2     L HTR B9A+4
       STO P7        ERROR EXIT
       CLA K9A+5     L TRA B9B
       STO P13       PROGRAM RETURN
       TRA P4        
 P3    CLA ADR       
       STO P6        
       CLA K9A+3     L HTR B10A
       STO P7        ERROR EXIT
       CLA B10+7     L TRA B11-1
       STO P13       PROGRAM RETURN
       STQ QUOT      
       CAL QUOT      TEST WORD
       SLW PR5       
 ...
 NPER  SWT 3         
       ...
       IOCD PNPER,0,24
       REM           
* PRINT -                NOW PERFORMING-9S04L-STORAGE TEST
* IMAGE -                NOW PERFORMING-9S04L-STORAGE TEST
 PNPER OCT 000000045040  9 ROW LEFT
       ...
       REM           
* PRINT -                   PASS COMPLETE-9S04L-STORAGE TEST
* IMAGE -                   PASS COMPLETE-9S04L-STORAGE TEST
 PPER  OCT 000000000010  9 ROW LEFT
       ...
       OCT 630000000000  11 R
       OCT 000000210240  12 L
       OCT 007100000000  12 R
       REM           
       REM           
       REM           
       REM           CONSTANTS
 ...
 TEST2 OCT 777777777777      BEAT WORD
       REM           
       REM           
 LOW   OCT           000 IS THE MIN VALUE THAT
       REM           CAN BE USED
 HIGH  OCT           75777 IS THE MAX VALUE THAT
       REM           CAN BE USED
       REM           
 ADR   OCT 77777     
 ...
 P6    OCT           ERROR ADDRESS
       REM           
 P7    OCT           ERROR EXIT
 QUOT  OCT           TEMP STG BEAT PATTERN
       REM           
       REM           PRINT IMAGE FOR FIRST LINE
