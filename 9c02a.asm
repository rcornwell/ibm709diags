...
CR24   LXA K,1        L 30 IN XRA
       ...
       REM            
       TIX CR24+2,1,4 CHECK EVERY FOURTH WORD
...
CR26   LNT 40000      INCREASE DELAY
       ...
       STO ROWD1      
       ANA            36 USEC DELAY
       AXT 12,1       L 14 IN XRA
       TIX *,1,1      DELAY 2.5 MS FROM 12 R TIME
       REM            
...
CR28   LNT 10000      INCREASE DELAY BETWEEN
       ...
       TRA PR1        TO TIMING PRINT ROUTINE
       REM            
CR28A  AXT 1744,1     L 3320 IN XRA
       TIX  *,1,1     DELAY 42 MS
       ANA            36 USEC DELAY
       REM            
...
CR29   LNT 4000       INCREASE DELAY BETWEEN
       ...
       TSX REDUC,4    TO REDUCE RECORD COUNT
       REM            
       AXT 767,1      L 1377 IN XRA
       TXI *+1,1,1    XRA NOW 1400
...
CR30   SWT 5          TEST SENSE SWITCH 5
       ...
       REM            
       AXT 6,1        L 6 XRA
       TIX  *,1,1     DELAY 2.5 MIS FROM 12 R TIME 
       ANA            36 USE DELAY
       REM            
*AT EOR TIME-224 ON INDEX, LOAD CHANNEL INSTR FOR 9L OF NEXT RECORD
       REM            
