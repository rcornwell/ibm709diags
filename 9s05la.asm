 ...
 E3    CLA T2
       ...
       REM
 E4    CLA T1
       STO 1024,1    RESTORE PATTERN
       CAS 1025,1    TEST NEXT WORD
       TRA P2        ERROR
       TRA E5        OK
       TRA P2        ERROR
       REM
 E5    CLA T2
       STO 1025,1    COMPLEMENT WORD
       CAS 1025,1
 ...
 E7    CLA E2        BLOCK REVERSAL
       ...
       REM
       TXL E9,2,1
       LDQ T1        REVERSE PATTERN FOR NEXT
       CLA T2        BLOCK
       STO T1
       STQ T2
       TIX E1,2,1
 ...
 E10A  CLA K+2       L +2
       STO K         RESTORE 2 COUNT
       CLA K+3       L STO 1024,1
       STO A         RESTORE INITIAL VALUES
       STO E3+1
       STO E4+1
       ADD K+1       L +1
       STO A+1
 ...
 NPER  SWT 3
       ...
       IOCD PNPER,0,24
       REM
* PRINT -                NOW PERFORMING-9S05L-STORAGE TEST
* IMAGE -                NOW PERFORMING-9S05L-STORAGE TEST
 PNPER OCT 000000045040  9 ROW LEFT
       ...
       REM
* PRINT -                   PASS COMPLETE-9S05L-STORAGE TEST
* IMAGE -                   PASS COMPLETE-9S05L-STORAGE TEST
